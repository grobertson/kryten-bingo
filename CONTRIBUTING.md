# Contributing to Kryten Bingo

Thank you for considering contributing to Kryten Bingo! This document provides guidelines for contributing to the project.
...
1. Clone your fork:
```bash
git clone https://github.com/YOUR_USERNAME/kryten-bingo.git
cd kryten-bingo
```
...
```bash
poetry run pytest --cov=kryten_bingo --cov-report=term-missing
```
